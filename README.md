...
<img src="public/images/home-hero.png" alt="Who Remembers Echo main visual" width="100%" />

### 챕터 공간

| Chapter 1. 깨어난 방 | Chapter 2. 관찰실 |
| --- | --- |
| <img src="public/assets/chapter1/room_main.png" alt="Chapter 1 isolation room" width="100%" /> | <img src="public/assets/chapter2/futuristic_hallway_with_security_features.png" alt="Chapter 2 observation area" width="100%" /> |

| Chapter 3. 기억 실험실 | Chapter 4. 코어 룸 |
| --- | --- |
| <img src="public/assets/chapter3/ch3_memory_lab_main.png" alt="Chapter 3 memory lab" width="100%" /> | <img src="public/assets/chapter4/ch4_core_room_main.png" alt="Chapter 4 core room" width="100%" /> |

### 등장인물

| 이안 | ECHO | 한세린 |
| --- | --- | --- |
| <img src="public/assets/characters/ian.png" alt="Ian character portrait" width="100%" /> | <img src="public/assets/characters/echo_robot.png" alt="ECHO character portrait" width="100%" /> | <img src="public/assets/characters/serin.png" alt="Han Serin character portrait" width="100%" /> |
...
| 탈출 | 세린의 배신 | 박사의 완성 |
| --- | --- | --- |
| <img src="public/assets/endings/ending_escape_alone.png" alt="Escape ending" width="100%" /> | <img src="public/assets/endings/ending_serin_betrayal.png" alt="Serin betrayal ending" width="100%" /> | <img src="public/assets/endings/ending_doctor_completion.png" alt="Doctor completion ending" width="100%" /> |

| 공존 | 서하의 이름 |
| --- | --- |
| <img src="public/assets/endings/ending_coexistence.png" alt="Coexistence ending" width="100%" /> | <img src="public/assets/endings/ending_hidden_seoha_name.png" alt="Seoha name hidden ending" width="100%" /> |

## 앱 구성

- `StartScreen`: 홈 타이틀 화면. 메인 비주얼, 시작/이어하기/저장 삭제 버튼을 표시합니다.
- `ImageArchive`: 챕터 이미지, 등장인물, 중요 단서, 엔딩 이미지를 모아 보여주는 비주얼 기록실입니다.
